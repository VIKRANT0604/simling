...
BOT_USERNAME = getenv("BOT_USERNAME", "Smiling_music_robot")
BOT_NAME = getenv("BOT_NAME", "˹ ꜱᴍɪʟɪɴɢ ꭙ ᴍᴜꜱɪᴄ ᴺᴼ ᴬᴰˢ♡゙")
ASSUSERNAME = getenv("ASSUSERNAME", "similing_assistant")
EVALOP = list(map(int, getenv("EVALOP", "7844391683").split()))
MONGO_DB_URI = getenv("MONGO_DB_URI", None)
LOGGER_ID = int(getenv("LOGGER_ID", -1001929010431))
...
UPSTREAM_REPO = getenv("UPSTREAM_REPO", "https://github.com/VIKRANT0604/simling")
